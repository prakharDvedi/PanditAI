...
export default function PredictionClient() {
  ...
  return (
    <>
      {/* Header (Moved from Server Component to access 'data') */}
      ...
      {/* Tab Navigation */}
      <div className="max-w-7xl mx-auto px-8 mt-8 flex gap-8 overflow-x-auto pb-2 scrollbar-hide border-b border-white/5">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            onClick={() => {
